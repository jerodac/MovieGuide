...
import br.eng.jerodac.movieguide.database.MovieContract.MovieEntry;
...
public class MovieProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(CONTENT_AUTHORITY, PATH_MOVIE + "/#", MOVIE_ID);
        matcher.addURI(CONTENT_AUTHORITY, PATH_GENRE, GENRE);
        matcher.addURI(CONTENT_AUTHORITY, PATH_GENRE + "/#", GENRE_ID);
        return matcher;
    }
